...
export default class Index extends Component {
  ...
  render() {
    ...
    const contactSrc = "https://audio-1258431868.cos.ap-chengdu.myqcloud.com/fire_calculator/fire_contact.png";
    ...
    return (
      ...
      <View className="spacing">
        <View style="white-space:pre-wrap">
          ...
          <View className="spacing"/>
          <Text>以当前资产比例配置({this.state.stock}%股票,{this.state.bond}%债券,{this.state.cash}%现金), {withdrawRate}%年支出速度, 您将有{successRate}%概率退休成功。</Text>
